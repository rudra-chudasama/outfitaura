...
$select = "SELECT * FROM `upload` WHERE `cate_id` = 2";
...
==========================-->
    ...
    <section class="section1 ">
        <div class="banner ">
            <img src="img/banner/womanimg.jpg">
        </div>
        </div>
    </section>
    <!--=========================
                    ...
                    <div class="product">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col">
                                        <img src="img/female/top/t1.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                    ...
                    <div class="product">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col">
                                        <img src="img/female/top/t2.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                    ...
                    <div class="product">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col">
                                        <img src="img/female/top/t3.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col-4">
                                        <img src="img/female/top/t4.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                    ...
                    <div class="product">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col">
                                        <img src="img/female/top/t5.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                    ...
                    <div class="product">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="promore-col">
                                        <img src="img/female/top/t6.jpg" width="100%" class="more" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/pant/p1.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/pant/p2.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/pant/p3.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/pant/p4.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/pant/p5.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
            ...
            <div class="col-lg-6">
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col-6">
                                    <img src="img/female/pant/p6.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f1.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f2.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f3.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f4.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f5.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/shoes/f6.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/assesories/a1.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
            ...
            <div class="col-lg-6">
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col-2">
                                    <img src="img/female/assesories/a2.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/assesories/a3.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/assesories/a4.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/assesories/a5.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
                ...
                <div class="product">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="promore-col">
                                    <img src="img/female/assesories/a6.jpg" width="100%" class="more" alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="product-details">
