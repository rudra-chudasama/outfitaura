...
$select1 = "SELECT * FROM `upload` WHERE `cate_id` = 1 AND `name` LIKE '%$search%'";
$result1 = mysqli_query($cost, $select1);

// $select1 = "SELECT * FROM `upload` WHERE `cate_id` = 1";
// $result1 = mysqli_query($cost, $select1);

$select2 = "SELECT * FROM `upload` WHERE `cate_id` = 2 AND `name` LIKE '%$search%'";
$result2 = mysqli_query($cost, $select2);

$select3 = "SELECT * FROM `upload` WHERE `cate_id` = 3 AND `name` LIKE '%$search%'";
$result3 = mysqli_query($cost, $select3);
            ...
            <div class="row">
                <div class="product">
                    <div class="col-lg-12">
                                    ...
                                    while ($row1 = mysqli_fetch_assoc($result1)) { ?>
                                        <li class="card-item swiper-slide text-center">
                                            <a href="product-details.php?id=<?php echo $row1['id']; ?>"
                                                ...
                                                <img src="admin_panel/<?php echo $row1['image']; ?>" class="card-image">
                                                <h2 class="card-title text-center my-2">
                                                    <?php echo $row1['name']; ?></h2>
                                                <p class="text-center">4.5<i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star-half-stroke"></i></p>
                                                <strong><span class="price">₹<?php echo $row1['price']; ?></span></strong>
                                                <a href="addtocart.php?id=<?php echo $row1['id']; ?>"
                                                    class="mb-3 btn btn-warning text-center"><i
                        ...
                        <div class="seemore">
                            <a href="mans-Ware.php"><button class="button btn btn-outline-warning">View
                                    More</button></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-wrapper ">
                                <ul class="card-list swiper-wrapper ">
                                    ...
                                    while ($row2 = mysqli_fetch_assoc($result2)) { ?>
                                        <li class="card-item swiper-slide text-center ">
                                            <a href="product-details.php?id=<?php echo $row2['id']; ?> "
                                                class="card-link text-center ">
                                                <img src="admin_panel/<?php echo $row2['image']; ?>" class="card-image ">
                                                <h2 class="card-title text-center "><?php echo $row2['name']; ?></h2>
                                                <!-- <p class="badge ">Lake</p> -->
                                                <p class="text-center">4.5<i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star-half-stroke"></i></p>
                                                <strong><span class="price ">₹<?php echo $row2['price']; ?></span></strong>
                                                <a href="addtocart.php?id=<?php echo $row1['id']; ?>?id=<?php echo $row1['id']; ?> "
                                                    class="mb-3 btn btn-warning text-center "><i
                                                        class="fa-solid fa-cart-shopping "></i>Buy Now</a>
                                            </a>
                                        </li>
                            ...
                            <div class="card-wrapper ">
                                <ul class="card-list swiper-wrapper ">
                                    ...
                                    while ($row3 = mysqli_fetch_assoc($result3)) { ?>
                                        <li class="card-item swiper-slide text-center ">
                                            <a href="product-details.php?id=<?php echo $row3['id']; ?> "
                                                class="card-link text-center ">
                                                <img src="admin_panel/<?php echo $row3['image']; ?>" class="card-image ">
                                                <h2 class="card-title text-center "><?php echo $row3['name']; ?></h2>
                                                <!-- <p class="badge ">Lake</p> -->
                                                <p class="text-center">4.5<i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star"></i><i
                                                        class="fa-solid fa-star-half-stroke"></i></p>
                                                <strong><span class="price ">₹<?php echo $row3['price']; ?></span></strong>
                                                <a href="addtocart.php?id=<?php echo $row3['id']; ?> "
                                                    class="mb-3 btn btn-warning text-center "><i
                                                        class="fa-solid fa-cart-shopping "></i>Buy Now</a>
                                            </a>
                                        </li>
